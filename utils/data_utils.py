...
_IRIS_DATA = np.array([
    ...
    [5.4, 3.7, 1.5, 0.2], [4.8, 3.4, 1.6, 0.2], [4.8, 3.0, 1.4, 0.1], [
        4.3, 3.0, 1.1, 0.1], [5.8, 4.0, 1.2, 0.2],
    [5.7, 4.4, 1.5, 0.4], [5.4, 3.9, 1.3, 0.4], [5.1, 3.5, 1.4, 0.3], [
        5.7, 3.8, 1.7, 0.3], [5.1, 3.8, 1.5, 0.3],
    [5.4, 3.4, 1.7, 0.2], [5.1, 3.7, 1.5, 0.4], [4.6, 3.6, 1.0, 0.2], [
        5.1, 3.3, 1.7, 0.5], [4.8, 3.4, 1.9, 0.2],
    ...
    [4.8, 3.1, 1.6, 0.2], [5.4, 3.4, 1.5, 0.4], [5.2, 4.1, 1.5, 0.1], [
        5.5, 4.2, 1.4, 0.2], [4.9, 3.1, 1.5, 0.1],
    [5.0, 3.2, 1.2, 0.2], [5.5, 3.5, 1.3, 0.2], [4.9, 3.6, 1.4, 0.1], [
    ...
    [5.9, 3.2, 4.8, 1.8], [6.1, 2.8, 4.0, 1.3], [6.3, 2.5, 4.9, 1.5], [
        6.1, 2.8, 4.7, 1.2], [6.4, 2.9, 4.3, 1.3],
    ...
    [5.5, 2.4, 3.8, 1.1], [5.5, 2.4, 3.7, 1.0], [5.8, 2.7, 3.9, 1.2], [
        6.0, 2.7, 5.1, 1.6], [5.4, 3.0, 4.5, 1.5],
    ...
    [6.5, 3.2, 5.1, 2.0], [6.4, 2.7, 5.3, 1.9], [6.8, 3.0, 5.5, 2.1], [
        5.7, 2.5, 5.0, 2.0], [5.8, 2.8, 5.1, 2.4],
    ...
    [6.9, 3.2, 5.7, 2.3], [5.6, 2.8, 4.9, 2.0], [7.7, 2.8, 6.7, 2.0], [
        6.3, 2.7, 4.9, 1.8], [6.7, 3.3, 5.7, 2.1],
    ...
    [6.7, 3.0, 5.2, 2.3], [6.3, 2.5, 5.0, 1.9], [
...
def load_data(dataset_name):
    if dataset_name == 'iris':
        return _IRIS_DATA.copy(), _IRIS_TARGET.copy()
    elif dataset_name == 'digits':
        from sklearn import datasets
        digits = datasets.load_digits()
        return digits.data.copy(), digits.target.copy()
    else:
